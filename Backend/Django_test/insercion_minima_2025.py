...
def aplicar_multiplicadores(mes):
    ...
    for consumicion in consumo_directo:
        multiplicador = consumicion["multiplicadores"].get(mes)
        if multiplicador:
...
def generar_datos(num_huespedes, mes, año, id_base):
    ...
    for i in range(1, num_huespedes + 1):
        ...
        total_ordenes = random.randint(3, 6)
...
def obtener_consumos_iniciales():  
    ...
    consumo_cocktail = [
        {"nombre": "Margarita", "consumo_mensual": 100 , "multiplicadores": {"invierno": 0.8, "verano": 1.2}},
        {"nombre": "Martini", "consumo_mensual": 75 , "multiplicadores": {"invierno": 1.1, "verano": 0.9}},
        {"nombre": "Cosmopolitan", "consumo_mensual": 90 , "multiplicadores": {"invierno": 0.9, "verano": 1.3}},
        {"nombre": "Mojito", "consumo_mensual": 125 , "multiplicadores": {"invierno": 0.7, "verano": 1.5}},
        {"nombre": "Daiquiri", "consumo_mensual": 110 , "multiplicadores": {"invierno": 0.8, "verano": 1.4}},
        {"nombre": "Piña Colada", "consumo_mensual": 95 , "multiplicadores": {"invierno": 0.8, "verano": 1.3}},
        {"nombre": "Bloody Mary", "consumo_mensual": 70 , "multiplicadores": {"invierno": 1.2, "verano": 0.8}},
        {"nombre": "Tequila Sunrise", "consumo_mensual": 105 , "multiplicadores": {"invierno": 0.9, "verano": 1.4}},
        {"nombre": "Manhattan", "consumo_mensual": 80 , "multiplicadores": {"invierno": 1.3, "verano": 0.8}},
        {"nombre": "Caipirinha", "consumo_mensual": 100 , "multiplicadores": {"invierno": 0.7, "verano": 1.6}},
        {"nombre": "Daiquiri Congelado", "consumo_mensual": 120 , "multiplicadores": {"invierno": 0.8, "verano": 1.5}},
        {"nombre": "Negroni", "consumo_mensual": 75 , "multiplicadores": {"invierno": 1.3, "verano": 0.9}},
        {"nombre": "Sex on the Beach", "consumo_mensual": 115 , "multiplicadores": {"invierno": 0.9, "verano": 1.4}},
        {"nombre": "Rum Punch", "consumo_mensual": 110 , "multiplicadores": {"invierno": 0.8, "verano": 1.5}},
        {"nombre": "Passionfruit Martini", "consumo_mensual": 85 , "multiplicadores": {"invierno": 1.0, "verano": 1.2}},
        {"nombre": "Cuba Libre", "consumo_mensual": 130 , "multiplicadores": {"invierno": 0.7, "verano": 1.5}},
        {"nombre": "Aperol Spritz", "consumo_mensual": 100 , "multiplicadores": {"invierno": 0.8, "verano": 1.4}},
    ]

    consumo_directo = [
        {"nombre": "Vodka", "consumo_mensual": 200 , "multiplicadores": {"invierno": 0.8, "verano": 1.3}},
        {"nombre": "Ron", "consumo_mensual": 200 , "multiplicadores": {"invierno": 0.9, "verano": 1.5}},
        {"nombre": "Tequila", "consumo_mensual": 160 , "multiplicadores": {"invierno": 0.8, "verano": 1.2}},
        {"nombre": "Ginebra", "consumo_mensual": 180 , "multiplicadores": {"invierno": 0.85, "verano": 1.4}},
        {"nombre": "Whisky", "consumo_mensual": 150, "multiplicadores": {"invierno": 1.3, "verano": 0.7}},
        {"nombre": "Jugo de Naranja", "consumo_mensual": 125 , "multiplicadores": {"invierno": 1.0, "verano": 1.5}},
        {"nombre": "Soda", "consumo_mensual": 150 , "multiplicadores": {"invierno": 0.9, "verano": 1.6}},
        {"nombre": "Azúcar", "consumo_mensual": 100 , "multiplicadores": {"invierno": 1.0, "verano": 1.0}},
        {"nombre": "Hielo", "consumo_mensual": 140 , "multiplicadores": {"invierno": 0.5, "verano": 2.0}},
        {"nombre": "Menta", "consumo_mensual": 50 , "multiplicadores": {"invierno": 0.8, "verano": 1.2}},
        {"nombre": "Jugo de Limón", "consumo_mensual": 75 , "multiplicadores": {"invierno": 1.0, "verano": 1.4}},
        {"nombre": "Triple Sec", "consumo_mensual": 50 , "multiplicadores": {"invierno": 1.0, "verano": 1.1}},
        {"nombre": "Granadina", "consumo_mensual": 60 , "multiplicadores": {"invierno": 1.0, "verano": 1.5}},
        {"nombre": "Piña", "consumo_mensual": 100 , "multiplicadores": {"invierno": 0.9, "verano": 1.6}},
        {"nombre": "Salsa Inglesa", "consumo_mensual": 25 , "multiplicadores": {"invierno": 1.0, "verano": 1.0}},
        {"nombre": "Cranberry", "consumo_mensual": 55 , "multiplicadores": {"invierno": 0.9, "verano": 1.2}},
        {"nombre": "Vermouth", "consumo_mensual": 45 , "multiplicadores": {"invierno": 1.1, "verano": 0.9}},
        {"nombre": "Amargo", "consumo_mensual": 25 , "multiplicadores": {"invierno": 1.0, "verano": 1.0}},
        {"nombre": "Crema de Coco", "consumo_mensual": 35 , "multiplicadores": {"invierno": 0.8, "verano": 1.3}},
        {"nombre": "Cachaça", "consumo_mensual": 50 , "multiplicadores": {"invierno": 0.9, "verano": 1.4}},
        {"nombre": "Limoncello", "consumo_mensual": 50 , "multiplicadores": {"invierno": 0.9, "verano": 1.3}},
        {"nombre": "Cerveza", "consumo_mensual": 250 , "multiplicadores": {"invierno": 0.8, "verano": 2.0}},
        {"nombre": "Ouzo", "consumo_mensual": 50 , "multiplicadores": {"invierno": 0.9, "verano": 1.1}},
        {"nombre": "Vino", "consumo_mensual": 230 , "multiplicadores": {"invierno": 1.5, "verano": 0.8}},
        {"nombre": "Puré de Maracuyá", "consumo_mensual": 25 , "multiplicadores": {"invierno": 0.9, "verano": 1.3}},
        {"nombre": "Licor de Cereza", "consumo_mensual": 25 , "multiplicadores": {"invierno": 1.0, "verano": 1.2}},
        {"nombre": "Aperol", "consumo_mensual": 50 , "multiplicadores": {"invierno": 1.0, "verano": 1.3}},
        {"nombre": "Vino Espumante", "consumo_mensual": 150 , "multiplicadores": {"invierno": 1.2, "verano": 0.9}},
        {"nombre": "Campari", "consumo_mensual": 45 , "multiplicadores": {"invierno": 1.0, "verano": 1.2}}
    ]
...
def cerrar_ordenes_activas(mes, año):
    ...
    print(f"Se han cerrado {ordenes_activas.count()} órdenes activas para {mes}/{año}.")
...
id25 = [
    {"mes": 1, "id": 1110000},{"mes": 2, "id": 2220000},{"mes": 3, "id": 3330000},
    {"mes": 4, "id": 4440000},{"mes": 5, "id": 5550000},{"mes": 6, "id": 6660000},
    {"mes": 7, "id": 7770000},{"mes": 8, "id": 8880000},{"mes": 9, "id": 9990000},
    {"mes": 10, "id": 1110100},{"mes": 11, "id": 1911100},{"mes": 12, "id": 1512000}
]
...
datos_huespedes = {
    1: 45, 2: 28, 3: 28, 4: 47, 5: 58, 6: 88, 
    7: 126, 8: 112, 9: 100, 10: 79, 11: 70, 12: 100
}

año = 2025

for mes in range(1, 2):  # 1 mes en 2025

    huespedes = datos_huespedes[mes] 
    mult = datos_huespedes[mes] / huespedes_por_mes[mes]

    id_base = next(item["id"] for item in id25 if item["mes"] == mes)

...
def obtener_consumos_iniciales():  
    ...
    consumo_directo = [
        ...
        {"nombre": "Ron", "consumo_mensual": 18 , "multiplicadores": {"invierno": 1, "verano": 1.5}},
        {"nombre": "Tequila", "consumo_mensual": 16 , "multiplicadores": {"invierno": 1.5, "verano": 0.5}},
        {"nombre": "Soda", "consumo_mensual": 20 , "multiplicadores": {"invierno": 1, "verano": 1.5}},
        {"nombre": "Jugo de Limón", "consumo_mensual": 12 , "multiplicadores": {"invierno": 1, "verano": 1}},
]
...
for mes in range(1, 13):  # 12 meses
    ...
    id_base = next(item["id"] for item in id22 if item["mes"] == mes)
